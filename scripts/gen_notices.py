...
BUNDLE = r"E:\ABU\ABUZ8_OS_DIST"
rows=[]
for pj in glob.glob(BUNDLE + r"\**\package.json", recursive=True):
    try:
    ...
    if not lic and d.get("licenses"):
        try: lic=d["licenses"][0].get("type","UNKNOWN")
...
with open(out,"w",encoding="utf-8") as f:
    ...
    f.write("  Liquid Foundation Models (LFM2 / LFM2.5) by Liquid AI\n")
