...
- Electron - desktop application shell. (c) Electron contributors / GitHub Inc.
- Node.js and the npm ecosystem.

## Everything else
- 340 open-source packages make this work, all under permissive licenses
  (MIT, ISC, Apache-2.0, BSD, BlueOak). Every one is listed with its license in
